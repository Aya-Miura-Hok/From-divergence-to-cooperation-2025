...
physeq_filtered <- subset_samples(ps, Type %in% c("leaf", "tile_l", "tile_d", "sediment_5", "sediment_20"))
physeq_filtered <- prune_samples(sample_sums(physeq_filtered) > 999, physeq_filtered)
...
coverage_based_results <- read.csv("https://raw.githubusercontent.com/Aya-Miura-Hok/From-divergence-to-cooperation-2025/refs/heads/main/data/fungi/iNEXT_Sitewise_Results_coverage_based_type.csv")
